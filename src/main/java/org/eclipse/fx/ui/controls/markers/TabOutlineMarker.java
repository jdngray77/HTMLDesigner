...
public final class TabOutlineMarker extends Group {
	...
	public void updateBounds(Bounds containerBounds, Bounds referenceBounds, boolean before) {
		...
		if (before) {
			_referenceBounds = new BoundingBox(_referenceBounds.getMinX(), Math.max(0, _referenceBounds.getMinY() - _referenceBounds.getHeight() / 2), _referenceBounds.getWidth(), _referenceBounds.getHeight());
		} else {
			_referenceBounds = new BoundingBox(_referenceBounds.getMinX(), Math.max(0, _referenceBounds.getMaxX() - _referenceBounds.getHeight() / 2), _referenceBounds.getWidth(), _referenceBounds.getHeight());
		}
		...
		// start
				...
				Double.valueOf(_referenceBounds.getMinX()), Double.valueOf(0.0),
				...
				// right
				// -----------------
				Double.valueOf(containerBounds.getMaxX() - _referenceBounds.getWidth()), Double.valueOf(containerBounds.getMaxY()),
