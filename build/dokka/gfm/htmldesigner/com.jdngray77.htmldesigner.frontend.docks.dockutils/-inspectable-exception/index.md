//[htmldesigner](../../../index.md)/[com.jdngray77.htmldesigner.frontend.docks.dockutils](../index.md)/[InspectableException](index.md)

# InspectableException

[jvm]\
class [InspectableException](index.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)

Exception thrown when properties marked [Inspectable](../-inspectable/index.md) are not fit to be so.
...
| | |
|---|---|
| [InspectableException](-inspectable-exception.md) | [jvm]<br>fun [InspectableException](-inspectable-exception.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
